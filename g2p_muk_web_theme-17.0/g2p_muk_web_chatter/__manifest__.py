    ...
    'assets': {
        'web._assets_primary_variables': [
            (
                ...
                'g2p_muk_web_chatter/static/src/scss/variables.scss'
            ),
        ],
        'web.assets_backend': [
            (
                ...
                'g2p_muk_web_chatter/static/src/views/form/form_compiler.js'
            ),
            'g2p_muk_web_chatter/static/src/core/**/*.xml',
            'g2p_muk_web_chatter/static/src/core/**/*.scss',
        ],
    },
    'images': [
