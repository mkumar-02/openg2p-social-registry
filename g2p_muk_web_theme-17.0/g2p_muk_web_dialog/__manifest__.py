    ...
    'assets': {
        'web.assets_backend': [
            (
                ...
                '/g2p_muk_web_dialog/static/src/core/dialog/dialog.js',
            ),
            (
                'after',
                'web/static/src/core/dialog/dialog.scss',
                '/g2p_muk_web_dialog/static/src/core/dialog/dialog.scss',
            ),
            (
                'after',
                'web/static/src/core/dialog/dialog.xml',
                '/g2p_muk_web_dialog/static/src/core/dialog/dialog.xml',
            ),
        ],
    },
    'images': [
