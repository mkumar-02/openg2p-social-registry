...
class ClientCredential(models.Model):
    _name = "g2p.dci.api.client.credential"
    _description = "G2P DCI Client Credential"
    ...
    def show_credentials(self):
        ...
        if not self.show_button_clicked:
            ...
            form_id = self.env.ref(
                "g2p_dci_api_server.g2p_dci_api_client_credential_view_credentials"
            ).id
